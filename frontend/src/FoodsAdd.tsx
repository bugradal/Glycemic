...
export default function FoodsAdd() {
  ...
  return (
    <>
      ...
      <Segment>
        <Form>
          <Form.Input onChange={(e) => setName(e.target.value)} fluid label='Gıda Adı' placeholder='Adı' />
          <Form.Input onChange={(e) => setGlycemicindex(e.target.value)} type='number' min='0' max='150' fluid label='Glisemik İndeks' placeholder='Glisemik İndeks' />
          ...
          <Form.Button color='teal' onClick={(e) => fncFoodAdd()} >Gönder</Form.Button>
        </Form>
      </Segment>
